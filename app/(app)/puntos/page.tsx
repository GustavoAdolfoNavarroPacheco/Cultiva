    ...
    <div className="mx-auto max-w-3xl">
      ...
      <ul className="mt-10 grid gap-4 sm:grid-cols-2">
        {puntos.map((punto, index) => (
          <li key={punto.id} className="animate-sprout-in" style={{ animationDelay: `${index * 70}ms` }}>
            <Link href={`/puntos/${punto.id}`} className="glass btn-glow block rounded-[var(--radius-lg)] p-5">
