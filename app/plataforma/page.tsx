...
export const metadata = {
  title: "Plataforma Educativa Sector Agro — Capacitación Agropecuaria",
  description:
    "Solución integral de educación agropecuaria: Módulo Administrativo, Modo Offline y Agente de WhatsApp.",
};

export default async function PlataformaEducativaPage() {
        ...
        <main className="flex-1 px-4 py-8 sm:px-6 sm:py-14">
          <div className="mx-auto max-w-6xl space-y-12">
            ...
            <div className="rounded-3xl bg-slate-900 p-8 sm:p-14 text-white shadow-xl relative overflow-hidden border border-slate-800">
              <div className="relative z-10 max-w-3xl space-y-4">
                <div className="inline-flex items-center gap-2 rounded-full bg-emerald-950 px-4 py-1.5 text-xs font-semibold uppercase tracking-wider text-emerald-300 border border-emerald-800/80">
                  <SproutIcon className="w-4 h-4 text-emerald-400" /> Plataforma Educativa Sector Agro
                </div>
                ...
                <p className="text-lg text-slate-300 font-medium leading-relaxed">
                  La Plataforma Educativa Sector Agro es una solución estructurada en tres pilares fundamentales, diseñada para brindar educación y capacitación accesible a estudiantes e integrantes del sector agropecuario, adaptándose tanto a zonas rurales sin conectividad como a entornos con acceso a internet.
                </p>
              </div>
            </div>
              ...
              <div className="grid gap-8 lg:grid-cols-3">
                ...
                >
                  <div>
                    ...
                    <span className="text-xs font-semibold uppercase tracking-wider text-emerald-800 bg-emerald-100/60 px-3 py-1 rounded-lg">
                      Pilar 1
                    </span>
                    ...
                    <p className="text-slate-600 font-normal text-sm leading-relaxed mb-4">
            ...
            <div className="card-farmer p-8 sm:p-10 bg-gradient-to-br from-white to-emerald-50/50">
              ...
              <p className="text-slate-600 font-normal text-base leading-relaxed max-w-3xl">
              ...
              <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-2xs">
                  ...
                  <p className="text-xs text-slate-500 font-normal mt-1">Duración máxima de 1 a 1.5 minutos para consumo óptimo de datos.</p>
                </div>
                <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-2xs">
                  <p className="font-bold text-slate-900 text-sm">Documentos PDF Breves</p>
                  <p className="text-xs text-slate-500 font-normal mt-1">Material de consulta rápida descargable directamente al teléfono.</p>
                </div>
                <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-2xs">
                  <p className="font-bold text-slate-900 text-sm">Evaluación Interactiva</p>
                  <p className="text-xs text-slate-500 font-normal mt-1">Preguntas sencillas de opción múltiple para medir el aprendizaje.</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 p-8 rounded-3xl bg-slate-900 text-white">
              <div>
                ...
                <p className="text-sm text-slate-300 font-medium mt-0.5">Explora los contenidos de la Plataforma Educativa Sector Agro.</p>
              </div>
