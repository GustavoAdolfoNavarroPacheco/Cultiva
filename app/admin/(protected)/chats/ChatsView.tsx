                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Adjunto si aplica */}
                      {msg.fileUrl && (
                        <div className="mt-2 pt-2 border-t border-slate-900/10 text-[11px] flex items-center justify-between gap-2">
                          <span className="flex items-center gap-1.5 font-bold truncate">
                            <PaperclipIcon className="w-3.5 h-3.5 text-emerald-800" />
                            {msg.fileName || (msg.fileMimeType?.includes("pdf") ? "Documento PDF" : "Video MP4")}
                          </span>
                          <a
                            href={msg.fileUrl}
                            target="_blank"
                            ...
                            className="px-2 py-0.5 rounded-lg bg-white/80 hover:bg-white text-emerald-900 font-bold border border-emerald-300 shrink-0 transition-colors"
                          >
                            Abrir / Descargar
                          </a>
                        </div>
